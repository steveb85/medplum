...
async function createProviderAccessPolicy(
  ...
  const policy = await systemRepo.createResource<AccessPolicy>({
    ...
    resource: [
      ...
      { resourceType: 'Media', readonly: false },
      ...
      { resourceType: 'Consent', readonly: false },
      { resourceType: 'Invoice', readonly: true },
...
async function createCoordinatorAccessPolicy(
  ...
  const policy = await systemRepo.createResource<AccessPolicy>({
    ...
    resource: [
      ...
      { resourceType: 'Procedure', readonly: true },
      { resourceType: 'Observation', readonly: true },
      { resourceType: 'Media', readonly: false },
      { resourceType: 'DocumentReference', readonly: true },
      { resourceType: 'Questionnaire', readonly: true },
      { resourceType: 'QuestionnaireResponse', readonly: true },
      { resourceType: 'Consent', readonly: true },
      { resourceType: 'Invoice', readonly: false },
      { resourceType: 'PaymentReconciliation', readonly: false },
      { resourceType: 'Organization', readonly: true },
    ],
  });
