...
async function createOrganization(systemRepo: SystemRepository, project: Project): Promise<Organization> {
  ...
  const organization = await systemRepo.createResource<Organization>({
    ...
    extension: [
      {
        url: 'http://melissaknudson.com/fhir/StructureDefinition/supervising-provider',
        valueReference: {
          reference: `Practitioner/${NURSE_MEL_DATA.firstName.toLowerCase()}-${NURSE_MEL_DATA.lastName.toLowerCase()}`,
          display: `${NURSE_MEL_DATA.firstName} ${NURSE_MEL_DATA.lastName}`,
        },
      },
    ],
  });
...
async function createProviderAccessPolicy(systemRepo: SystemRepository, project: Project): Promise<AccessPolicy> {
  ...
  const policy = await systemRepo.createResource<AccessPolicy>({
    ...
    resource: [
      ...
      { resourceType: 'RelatedPerson', interaction: ['read', 'vread', 'create', 'search'] },
      { resourceType: 'CareTeam', interaction: ['read', 'vread', 'search'] },
      { resourceType: 'Coverage', interaction: ['read', 'vread', 'create', 'search'] },
      ...
      { resourceType: 'MedicationStatement', interaction: ['read', 'vread', 'create', 'search'] },
      ...
      { resourceType: 'Flag', interaction: ['read', 'vread', 'create', 'search'] },
...
async function createServiceCatalog(systemRepo: SystemRepository, project: Project): Promise<void> {
  ...
  const services: {
    ...
    equipmentRequirements: { equipmentType: string; equipmentReference?: string; equipmentName?: string; required?: boolean; movable?: boolean }[];
    ...
    },
    {
      ...
      equipmentRequirements: [],
      recommendedAccompanyingServices: [{ serviceCode: 'topical-numbing', timing: 'before', offsetMinutes: -30 }],
      internalCost: { productCost: 400, notes: 'Sculptra product per vial' },
      mainProviderRequired: true,
      assistantRequired: false,
    },
    {
      ...
      equipmentRequirements: [],
      recommendedAccompanyingServices: [],
      internalCost: { productCost: 200, notes: 'Skinvive product' },
      mainProviderRequired: true,
      assistantRequired: false,
    },
    {
      ...
      equipmentRequirements: [],
      recommendedAccompanyingServices: [{ serviceCode: 'topical-numbing', timing: 'before', offsetMinutes: -30 }],
      internalCost: { productCost: 150, notes: 'Blood draw supplies + centrifuge' },
      mainProviderRequired: true,
    ...
    },
    {
      ...
      equipmentRequirements: [],
      recommendedAccompanyingServices: [],
      internalCost: { productCost: 100, notes: 'Aquagold device + cocktail' },
      mainProviderRequired: true,
      assistantRequired: false,
    },
    {
      ...
      color: 'red',
      category: 'laser-ipl',
      equipmentRequirements: [{ equipmentType: 'laser', equipmentName: 'Lumecca IPL', required: true, movable: false }],
      recommendedAccompanyingServices: [],
      internalCost: { productCost: 0, notes: 'No consumables' },
      mainProviderRequired: true,
      assistantRequired: false,
    },
    {
      ...
      equipmentRequirements: [{ equipmentType: 'laser', equipmentName: 'Clear + Brilliant', required: true, movable: false }],
      recommendedAccompanyingServices: [],
      internalCost: { productCost: 50, notes: 'Handpiece tip' },
      mainProviderRequired: true,
      assistantRequired: false,
    },
    {
      ...
      color: 'orange',
      category: 'laser-resurfacing',
      equipmentRequirements: [{ equipmentType: 'laser', equipmentName: 'Fraxel Dual', required: true, movable: false }],
      recommendedAccompanyingServices: [{ serviceCode: 'topical-numbing', timing: 'before', offsetMinutes: -60 }],
      internalCost: { productCost: 100, notes: 'Fraxel tip' },
      mainProviderRequired: true,
      assistantRequired: false,
    },
    {
      ...
      icon: 'bulb',
      color: 'pink',
      category: 'rf-skin-tightening',
      equipmentRequirements: [{ equipmentType: 'laser', equipmentName: 'Thermage', required: true, movable: false }],
      recommendedAccompanyingServices: [],
      internalCost: { productCost: 300, notes: 'Thermage tip' },
      mainProviderRequired: true,
      assistantRequired: false,
    },
    {
      ...
      color: 'teal',
      category: 'ultrasound',
      equipmentRequirements: [{ equipmentType: 'laser', equipmentName: 'Ulthera', required: true, movable: false }],
      recommendedAccompanyingServices: [],
      internalCost: { productCost: 200, notes: 'Ulthera transducer' },
      mainProviderRequired: true,
      assistantRequired: false,
    },
    {
      ...
      equipmentRequirements: [{ equipmentType: 'laser', equipmentName: 'Skin Pen', required: true, movable: false }],
      recommendedAccompanyingServices: [{ serviceCode: 'topical-numbing', timing: 'before', offsetMinutes: -30 }],
      internalCost: { productCost: 80, notes: 'Microneedling cartridge + serum' },
      mainProviderRequired: true,
      assistantRequired: false,
    },
  ];
